...
│                                                            │
│  • npm install -g repolens@latest    (global install)     │
│  • npm install repolens@latest       (local install)      │
│  • npx repolens@latest <command>     (always latest)      │
└────────────────────────────────────────────────────────────┘
```
...
Your workflow automatically uses the latest version with `npx repolens@latest`:
