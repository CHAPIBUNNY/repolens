...
<body>
  <div class="container">
      ...
      <div class="card">
        ...
        <div class="card-body">
          <div class="quick-links">
            ...
            ` : ''}
            <a href="https://rabitai.io" class="link-button" target="_blank">
              <span class="link-icon">🐰</span>
              <span class="link-text">RABITAI</span>
            </a>
          </div>
        </div>
      </div>
    ...
    <footer class="footer">
      <p>Generated by <a href="https://rabitai.io" target="_blank">RABITAI</a> 🐰</p>
    </footer>
  </div>
</body>
</html>`;
