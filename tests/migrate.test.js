...
`;
    ...
    expect(migrated).toContain("npx repolens@latest publish");
...
`;
    ...
    expect(migrated).toContain("npx repolens@latest");
...
`;
    ...
    expect(migrated1).toContain("npx repolens@latest");
    expect(migrated2).toContain("npx repolens@latest");
  });
